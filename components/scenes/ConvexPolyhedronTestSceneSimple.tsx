...
import { Geometry } from "three-stdlib";
 ...
 function toConvexProps(bufferGeometry) {
  ...
  function Diamond(props) {
    const diamond = useGLTF("/cube.glb")
    console.log(diamond)
    const geo = useMemo(() => toConvexProps(diamond.nodes.Cube.geometry), [diamond.nodes]);
    ...
    return (
      <mesh
        ...
        receiveShadow
        ref={ref}
        geometry={diamond.nodes.Cube.geometry}
        {...props}
      >
        <meshNormalMaterial />
      </mesh>
        ...
        <Suspense fallback={null}>
            <Physics gravity={[0, -30, 0]}>
                ...
                <Debug color="black">
                    ...
                    <Diamond position={[2, 5, 0]} rotation={[1, 0.1, 0.1]} />
